...
/**
 * Tests ODFLoader/ODFSaver. Run from the command line with:<p/>
 * java weka.core.converters.ODFTest
 *
...
public class ODFTest
  ...
  /**
   * Constructs the <code>ODFTest</code>.
   *
  ...
  public static Test suite() {
    return new TestSuite(ODFTest.class);
  }
