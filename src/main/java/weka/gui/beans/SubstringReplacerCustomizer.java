...
public class SubstringReplacerCustomizer extends JPanel implements
  ...
  private void setup() {
    ...
    m_newBut.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        SubstringReplacer.MatchReplace mr =
          new SubstringReplacer.MatchReplace();
        ...
        mr.setMatch(match);
        String replace = (m_replaceField.getText() != null)
          ? m_replaceField.getText() : "";
    ...
    if (mrString != null && mrString.length() > 0) {
      ...
      if (parts.length > 0) {
        ...
        for (String mrPart : parts) {
          SubstringReplacer.MatchReplace mr = 
            new SubstringReplacer.MatchReplace(mrPart);
          m_listModel.addElement(mr);
        }
  ...
  protected void closingOK() {
    ...
    for (int i = 0; i < m_listModel.size(); i++) {
      SubstringReplacer.MatchReplace mr =
        (SubstringReplacer.MatchReplace)m_listModel.elementAt(i);
