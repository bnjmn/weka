...
/** 
 * Abstract scheme for storing and pruning class associations. All schemes for storing and pruning
 * class associations implemement this class
 *
 *
...
public abstract class PruneCAR implements OptionHandler, Serializable{
     ...
     */    
    public abstract void preprocess(FastVector premises, FastVector consequences, FastVector confidences) throws Exception;
    ...
    /**
   * Creates a new instance of a PruneCAR given it's class name and
   ...
   */
    public static PruneCAR forName(String pruningName,
				   String [] options) throws Exception {

	return (PruneCAR)Utils.forName(PruneCAR.class,
				     pruningName,
				     options);
  }
