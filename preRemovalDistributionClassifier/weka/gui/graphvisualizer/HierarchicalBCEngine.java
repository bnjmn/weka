	...
	*/
	...
	for(int k=0; k<descOrder.length; k++)
		...
		while( Math.abs(horPositions[level[descOrder[i]]]-1-bCenters[descOrder[i]]) < 
		    ...
		    //System.out.println("Moving main "+((GraphNode)m_nodes.elementAt(level[descOrder[i]])).ID+" from "
		...
		while( Math.abs(horPositions[level[descOrder[i]]]+1-bCenters[descOrder[i]]) < 
			...
			if(temp==horPositions[level[rightNodes[j]]])
			    {   //System.out.println("Moving "+((Node)m_nodes.elementAt(level[rightNodes[j]])).ID+" from "
	...
	public void add(int i) {
		...
		if(last.next==null) {
		    ...
		    {System.err.println("Error shouldn't be in here. Check MyList code"); size--;}
	...
	public void remove(int i) {
	    ...
	    if(temp==null)
		{ System.err.println("element "+i+"not present in the list"); return;}
