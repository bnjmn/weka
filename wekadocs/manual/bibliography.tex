...
\begin{thebibliography}{999}
	...
	\bibitem{witten}
		...
		Francisco.
	\bibitem{wekawiki}
		\textit{WekaWiki} -- \texttt{http://weka.wiki.sourceforge.net/}
%	\bibitem{wekadoc}
%		\textit{WekaDoc} -- \texttt{http://weka.sourceforge.net/wekadoc/}
	...
	%	\small{\texttt{http://weka.sourceforge.net/wekadoc/index.php/en:Ensemble\_Selection}}
	\bibitem{mainextensions}
		\textit{Extensions for Weka's main GUI} on \textit{WekaWiki} -- \\
		\small{\texttt{http://weka.wiki.sourceforge.net/Extensions+for+Weka\%27s+main+GUI}}
	\bibitem{explorertabs}
		\textit{Adding tabs in the Explorer} on \textit{WekaWiki} -- \\
		\small{\texttt{http://weka.wiki.sourceforge.net/Adding+tabs+in+the+Explorer}}
	\bibitem{explorervisplugins}
		\textit{Explorer visualization plugins} on \textit{WekaWiki} -- \\
		\small{\texttt{http://weka.wiki.sourceforge.net/Explorer+visualization+plugins}}
	...
	\bibitem{subversion}
		\textit{Subversion} -- \texttt{http://weka.wiki.sourceforge.net/Subversion}
	\bibitem{hsql}
	...
	\bibitem{multipleroc}
		...
		\small{\texttt{http://weka.wiki.sourceforge.net/Plotting+multiple+ROC+curves}}
