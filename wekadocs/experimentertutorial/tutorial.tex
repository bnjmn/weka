...
\title{\epsfig{file=images/coat_of_arms.eps,width=10cm}\vspace{3cm}\\WEKA Experimenter Tutorial\\for Version 3-5-3}
...
\copyright 2002-2006 David Scuse and University of Waikato
...
The \textit{Filter...} button enables one to highlight classifiers that can handle certain attribute and class types. With \textit{Remove filter} the highlighting will be removed again.
