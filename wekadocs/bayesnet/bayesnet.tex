...
\title{\epsfig{file=images/coat_of_arms.eps,width=10cm}\vspace{3cm}\\Bayesian Network Classifiers in Weka\\for Version 3-5-7}
...
\copyright 2006-2007 University of Waikato
...
\begin{center}
\epsfig{file=images/gui.net.eps,height=7cm}
\end{center}
...
\begin{center}
\epsfig{file=images/local.algorithms.eps,height=8cm}
\end{center}
...
\begin{center}
\epsfig{file=images/score.sa.eps,height=5cm}
\end{center}
...
\begin{center}
\epsfig{file=images/score.tabu.eps,height=5cm}
\end{center}
...
\begin{center}
\epsfig{file=images/score.genetic.eps,height=8cm}
\end{center}
...
\begin{center}
\epsfig{file=images/global.algorithms.eps,height=8cm}
\end{center}
...
\begin{center}
\epsfig{file=images/global.k2.eps,height=6cm}
\end{center}
...
\begin{center}
\epsfig{file=images/fixed.algorithms.eps,height=8cm}
\end{center}
...
\begin{center}
\epsfig{file=editor/viewgraph.eps,height=12cm}
\end{center}
...
\begin{center}
\epsfig{file=editor/menufile.eps,height=4cm}
\end{center}
...
\begin{center}
\epsfig{file=editor/menuedit.eps,height=8cm}
\end{center}
...
\begin{center}
\epsfig{file=editor/dlg.addnode.eps,height=2.5cm}
\end{center}

The Add Arc menu brings up a dialog to choose a child node first;

\begin{center}
\epsfig{file=editor/dlg.addarc.eps,height=2cm}
\end{center}
...
\begin{center}
\epsfig{file=editor/dlg.addarc2.eps,height=2cm}
\end{center}
...
\begin{center}
\epsfig{file=editor/dlg.delarc.eps,height=2cm}
\end{center}
...
\begin{center}
\epsfig{file=editor/menutools.eps,height=5cm}
\end{center}
...
\begin{center}
\epsfig{file=editor/dlg.generate.eps,height=3.5cm}
\end{center}
...
\begin{center}
\epsfig{file=editor/dlg.generated.eps,height=3.5cm}
\end{center}
...
\begin{center}
\epsfig{file=editor/dlg.learn.eps,height=2cm}
\end{center}
...
\begin{center}
\epsfig{file=editor/dlg.layout.eps,height=3cm}
\end{center}
...
\begin{center}
\epsfig{file=editor/viewevidence.eps,height=8cm}
\end{center}
...
\begin{center}
\epsfig{file=editor/viewcliques.eps,height=8cm}
\end{center}
...
\begin{center}
\epsfig{file=editor/menuview.eps,height=5cm}
\end{center}
...
\begin{center}
\epsfig{file=editor/menuhelp.eps,height=2cm}
\end{center}
...
\begin{center}
\epsfig{file=editor/toolbar.eps, height=0.6cm}
\end{center}
...
\begin{center}
\epsfig{file=editor/popupmenuleft.eps,height=2.5cm}
\end{center}
...
\begin{center}
\epsfig{file=editor/pop.r.setevidence.eps,height=6cm}
\end{center}
...
\begin{center}
\epsfig{file=editor/dlg.renamenode.eps,height=2.5cm}
\end{center}
...
\begin{center}
\epsfig{file=editor/dlg.CPT.eps,height=6cm}
\end{center}
...
\begin{center}
\epsfig{file=editor/pop.r.addparent.eps,height=6cm}
\end{center}
...
parent node.
\begin{center}
\epsfig{file=editor/pop.r.delparent.eps,height=6cm}
\end{center}
...
of the parent node.
\begin{center}
\epsfig{file=editor/pop.r.delchild.eps,height=6cm}
\end{center}
...
the new value.
\begin{center}
\epsfig{file=editor/dlg.addvalue.eps,height=2.5cm}
\end{center}

The popup menu shows list of values that can be renamed for selected node.
\begin{center}
\epsfig{file=editor/pop.r.renvalue.eps,height=6cm}
\end{center}

Selecting a value brings up the following dialog in which a new name
can be specified.
\begin{center}
\epsfig{file=editor/dlg.renamevalue.eps,height=2.5cm}
\end{center}
...
\begin{center}
\epsfig{file=editor/pop.r.delvalue.eps,height=6cm}
\end{center}
