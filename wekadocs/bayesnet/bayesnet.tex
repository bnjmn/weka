...
\title{\epsfig{file=images/coat_of_arms.eps,width=10cm}\vspace{3cm}\\Bayesian Network Classifiers in Weka\\for Version 3-5-3}
...
XXX BayesNetEstimator XXX \\
XXX MultiNomialBMAEstimator XXX \\
...
The implementation of {\tt buildStructure} in the base class XXX.
