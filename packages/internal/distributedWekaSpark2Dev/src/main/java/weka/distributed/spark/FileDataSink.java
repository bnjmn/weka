...
public class FileDataSink extends DataSink {
  ...
  protected List<Dataset<Row>> applyColumnNamesOrNamesFile(List<Dataset<Row>> dfs)
    throws IOException, DistributedWekaException {
    List<Dataset<Row>> result = new ArrayList<Dataset<Row>>();
  ...
  protected Dataset<Row> coalesceToOnePartitionIfNecessary(Dataset<Row> df) {
  ...
  protected static Dataset<Row> cleanseColumnNames(Dataset<Row> df) {
