...
public class DatasetManager {
  ...
  protected transient Map<String, WDDataset> m_datasets =
    new HashMap<String, WDDataset>();
   ...
   */
  public void setDataset(String key, WDDataset dataset) {
   ...
   */
  public WDDataset getDataset(String key) {
   ...
   */
  public Iterator<Map.Entry<String, WDDataset>> getDatasetIterator() {
   ...
   */
  public Collection<WDDataset> getDatasets() {
    return m_datasets.values();
  }

  public void addAll(Iterator<Map.Entry<String, WDDataset>> toAdd) {
    while (toAdd.hasNext()) {
      Map.Entry<String, WDDataset> entry = toAdd.next();
