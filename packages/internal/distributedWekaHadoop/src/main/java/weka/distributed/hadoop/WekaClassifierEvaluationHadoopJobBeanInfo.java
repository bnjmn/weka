 ...
 * @version $Revision$
 */
public class WekaClassifierEvaluationHadoopJobBeanInfo extends
  HadoopJobBeanInfo {
  ...
  public PropertyDescriptor[] getPropertyDescriptors() {
    try {
      ...
      p1 = new PropertyDescriptor("numNodesInCluster",
        WekaClassifierEvaluationHadoopJob.class);
      pds.add(p1);

      p1 = new PropertyDescriptor("separateTestSetPath",
        WekaClassifierEvaluationHadoopJob.class);
      p1.setPropertyEditorClass(weka.gui.beans.EnvironmentField.class);
      pds.add(p1);

      p1 = new PropertyDescriptor("sampleFractionForAUC",
        WekaClassifierEvaluationHadoopJob.class);
      p1.setPropertyEditorClass(weka.gui.beans.EnvironmentField.class);
      pds.add(p1);
