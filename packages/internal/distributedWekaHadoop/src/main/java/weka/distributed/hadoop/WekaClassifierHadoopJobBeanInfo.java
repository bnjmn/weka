...
public class WekaClassifierHadoopJobBeanInfo extends HadoopJobBeanInfo {
  ...
  public PropertyDescriptor[] getPropertyDescriptors() {
    try {
      ...
      p1 = new PropertyDescriptor("minTrainingFraction",
        WekaClassifierHadoopJob.class);
      p1.setPropertyEditorClass(weka.gui.beans.EnvironmentField.class);
      pds.add(p1);
      ...
      p1 = new PropertyDescriptor("createRandomizedDataChunks",
        WekaClassifierHadoopJob.class);
      pds.add(p1);

      p1 = new PropertyDescriptor("numRandomizedDataChunks",
        WekaClassifierHadoopJob.class);
      p1.setPropertyEditorClass(weka.gui.beans.EnvironmentField.class);
      pds.add(p1);

      p1 = new PropertyDescriptor("numInstancesPerRandomizedDataChunk",
        WekaClassifierHadoopJob.class);
      p1.setPropertyEditorClass(weka.gui.beans.EnvironmentField.class);
      pds.add(p1);
