 ...
 * @version $Revision$
 */
public class KMeansClustererHadoopJobBeanInfo extends AbstractHadoopJobBeanInfo {
  ...
  public BeanDescriptor getBeanDescriptor() {
    return new BeanDescriptor(weka.gui.beans.KMeansClustererHadoopJob.class,
