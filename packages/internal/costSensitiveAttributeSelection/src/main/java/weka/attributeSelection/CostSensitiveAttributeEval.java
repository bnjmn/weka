...
/**
 * <!-- globalinfo-start --> A meta subset evaluator that makes its base subset
 ...
 * @version $Revision$
 */
public class CostSensitiveAttributeEval extends CostSensitiveASEvaluation
   ...
   * @throws IllegalArgumentException if the evaluator is not an instance of
   *           AttributeEvaluator
   */
  @Override
