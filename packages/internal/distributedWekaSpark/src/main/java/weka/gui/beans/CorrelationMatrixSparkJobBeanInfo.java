...
/*
 *    CorrelationMatrixSparkJobBeanInfo
...
/**
 * Bean info class for the correlation matrix spark job
 *
 * @author Mark Hall (mhall{[at]}pentaho{[dot]}com)
 * @version $Revision$
 */
public class CorrelationMatrixSparkJobBeanInfo extends AbstractSparkJobBeanInfo {
  ...
  public EventSetDescriptor[] getEventSetDescriptors() {
    ...
    try {
      ...
      descriptors.add(new EventSetDescriptor(CorrelationMatrixSparkJob.class,
  ...
  public BeanDescriptor getBeanDescriptor() {
    return new BeanDescriptor(weka.gui.beans.CorrelationMatrixSparkJob.class,
