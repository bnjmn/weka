...
/**
 * BeanInfo class for the CorrelationMatrixSparkJob
 *
 * @author Mark Hall (mhall{[at]}pentaho{[dot]}com)
 * @version $Revision$
 */
public class CorrelationMatrixSparkJobBeanInfo extends SparkJobBeanInfo {
    ...
    try {
      ...
      p1 =
        new PropertyDescriptor("classAttribute",
          CorrelationMatrixSparkJob.class);
      p1.setPropertyEditorClass(weka.gui.beans.EnvironmentField.class);
      pds.add(p1);

      p1 = new PropertyDescriptor("runPCA", CorrelationMatrixSparkJob.class);
      pds.add(p1);
