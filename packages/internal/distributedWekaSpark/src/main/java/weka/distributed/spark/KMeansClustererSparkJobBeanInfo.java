...
/*
 *    KMeansClustererSparkJobBeanInfo
...
/**
 * BeanInfo class for the KMeansClustererSparkJob
 *
 * @author Mark Hall (mhall{[at]}pentaho{[dot]}com)
 * @version $Revision$
 */
public class KMeansClustererSparkJobBeanInfo extends SparkJobBeanInfo {
