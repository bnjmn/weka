...
/**
 * Tests Nystroem. Run from the command line with: <p/>
 * java weka.filters.unsupervised.attribute.NystroemTest
 *
...
public class NystroemTest
    ...
    public static Test suite() {
        return new TestSuite(NystroemTest.class);
    }
