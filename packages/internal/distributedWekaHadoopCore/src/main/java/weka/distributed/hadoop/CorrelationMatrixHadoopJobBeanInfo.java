 ...
 * @version $Revision$
 */
public class CorrelationMatrixHadoopJobBeanInfo extends HadoopJobBeanInfo {
  ...
  public PropertyDescriptor[] getPropertyDescriptors() {
    try {
      ...
      p1 = new PropertyDescriptor("classAttribute",
        CorrelationMatrixHadoopJob.class);
      ...
      p1 = new PropertyDescriptor("runPCA", CorrelationMatrixHadoopJob.class);
      pds.add(p1);
