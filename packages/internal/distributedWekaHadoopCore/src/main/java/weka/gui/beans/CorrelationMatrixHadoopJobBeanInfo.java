 ...
 * @version $Revision$
 */
public class CorrelationMatrixHadoopJobBeanInfo extends
  AbstractHadoopJobBeanInfo {
  ...
  public BeanDescriptor getBeanDescriptor() {
    return new BeanDescriptor(weka.gui.beans.CorrelationMatrixHadoopJob.class,
