 ...
 */
public class SupervisedAttributeScaler extends SimpleBatchFilter 
  ...
  public String globalInfo() {
    return 
        "Rescales the attributes in a classification problem based on their discriminative power. This is "
  ...
  public TechnicalInformation getTechnicalInformation() {
    ...
    result.setValue(Field.AUTHOR, "L. Yang and R. Jin and R. Sukthankar and Y. Liu");
  ...
  public Enumeration listOptions() {
    ...
    result.addElement(new Option("\tIf set, weights are learned for Euclidean distance.\n",
                                 "-assume-Euclidean-distance", 0, "-assume-Euclidean-distance"));
    
    result.addElement(new Option("\tThe number of neighbours to use (default: 30).\n",
                                 "-K", 1, "-K"));
  ...
  public void setOptions(String[] options) throws Exception {
    ...
    setAssumeEuclideanDistance(Utils.getFlag("assume-Euclidean-distance", options));
  ...
  public void initFilter(Instances instances) throws Exception {
    ...
    Instances pairwiseData = new Instances("pairwise_data", atts, N * numNeighbours);
    for (int i = 0; i < N; i++) {
      ...
      for (int j = 0; j < numNeighbours; j++) {
        ...
        for (int k = 0; k < M; k++) {
          if (k != instances.classIndex()) {
            ...
            diffInst[k + 1] = (inst1.classValue() == inst2.classValue()) ? 1.0 : 0.0;
          }
        }
