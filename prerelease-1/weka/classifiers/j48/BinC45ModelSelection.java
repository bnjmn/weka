...
public class BinC45ModelSelection extends ModelSelection{
  ...
  private int minNoObJ;               // Minimum number of instances in interval.
  private Instances allDatA; // The FULL training dataset.
  ...
  public final ClassifierSplitModel selectModel(Instances data){
	...
	if (i != (data).classIndex()){
	  ...
	  //System.out.print("InfoGain attribute "+i+" "+
	  //	   currentModel[i].infoGain()+" ");
	  //System.out.println("Gain ratio "+currentModel[i].gainRatio());
	}else
	  currentModel[i] = null;
      }
      
      //System.out.println("No of valid splits: "+validModels);
	...
	return noSplitModel;
      ...
      //System.out.println("Average InfoGain: "+averageInfoGain);
