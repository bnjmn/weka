...
\title{\epsfig{file=coa-hor.eps,width=6cm}\vspace{3cm}\\WEKA Explorer User Guide\\for Version 3-4}
...
\begin{table}[b]
\copyright 2002-2011 University of Waikato \\
\\
This guide is licensed under the GNU General Public License version 2. More information about this license can be found at \url{http://www.gnu.org/copyleft/gpl.html}
\end{table}
