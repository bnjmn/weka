...
/**
 * Extends Properties to allow the value of a system property (if set)
 * to override that which has been loaded/set. This allows the user to
 * override from the command line any property that is loaded into a
 * property file via weka.core.Utils.readProperties().
 *
