 ...
 * 
 * To move the operator semantics outside the parser they are specified here.</br>
 * The parser can then call these methods so that operators can be resolved to
...
public class Operators {
  ...
  /**
   * '<code>regexp</code>' regexp operator (to check for string matching a given regular expression)
   */
  ...
  private static abstract class DoubleBinaryExpression implements DoubleExpression {
  ...
  private static class Addition extends DoubleBinaryExpression {
  ...
  private static class Subtraction extends DoubleBinaryExpression {
  ...
  private static class Multiplication extends DoubleBinaryExpression {
  ...
  private static class UMinus implements DoubleExpression {
  ...
  private static class Division extends DoubleBinaryExpression {
  ...
  private static class Pow extends DoubleBinaryExpression {
  ...
  private static abstract class BooleanBinaryExpression<T> implements BooleanExpression {
  ...
  private static class LessThan extends BooleanBinaryExpression<DoubleExpression> {
  ...
  private static class LessEqual extends BooleanBinaryExpression<DoubleExpression> {
  ...
  private static class GreaterThan extends BooleanBinaryExpression<DoubleExpression> {
  ...
  private static class GreaterEqual extends BooleanBinaryExpression<DoubleExpression> {
  ...
  private static class Concatenation implements StringExpression {
