    ...
    throws java.lang.Exception
    {
      ...
      switch (CUP$Parser$act_num)
          ...
          case 0: // expr_list ::= expr_list expr_part 
            {
              ...
              CUP$Parser$result = parser.getSymbolFactory().newSymbol("expr_list",0, RESULT);
            }
		...
		Double e = (Double)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 parser.setResult(e); 
              CUP$Parser$result = parser.getSymbolFactory().newSymbol("expr_part",1, RESULT);
            }
          return CUP$Parser$result;
		...
		String v = (String)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 if (parser.getSymbols().containsKey(v)) 
              ...
              CUP$Parser$result = parser.getSymbolFactory().newSymbol("varexpr",4, RESULT);
            }
          return CUP$Parser$result;
		...
		Double e = (Double)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-1)).value;
		 RESULT = new Double(Math.abs(e)); 
              CUP$Parser$result = parser.getSymbolFactory().newSymbol("funcexpr",5, RESULT);
            }
          return CUP$Parser$result;
		...
		Boolean b = (Boolean)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT = b; 
              CUP$Parser$result = parser.getSymbolFactory().newSymbol("boolexpr",6, RESULT);
            }
          return CUP$Parser$result;
