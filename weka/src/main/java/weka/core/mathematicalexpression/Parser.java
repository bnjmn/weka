...
public class Parser extends java_cup.runtime.lr_parser {
  ...
  /** Parse-action table. */
  protected static final short[][] _action_table = unpackFromStrings(new String[] { "\000\144\000\040\005\016\013\025\014\011\015\021\016"
  ...
  protected static final short[][] _reduce_table = unpackFromStrings(new String[] { "\000\144\000\016\002\025\003\021\004\005\005\026\006"
  ...
  protected HashMap<String, Double> m_Symbols = new HashMap<String, Double>();
   ...
   */
  public void setSymbols(HashMap<String, Double> value) {
    m_Symbols = value;
  }
  ...
  /**
   * Runs the parser from commandline. Either reads lines from System.in or from
   * a provided file (line by line). With
...
class CUP$Parser$actions {
  ...
  public final java_cup.runtime.Symbol CUP$Parser$do_action(
    ...
    case 37: // boolexpr ::= boolexpr OR boolexpr
    {
      ...
      RESULT = l || r;
      CUP$Parser$result = parser.getSymbolFactory().newSymbol("boolexpr", 6,
    ...
    {
      Double RESULT = null;
      Boolean b = (Boolean) CUP$Parser$stack.elementAt(CUP$Parser$top - 5).value;
      Double e_true = (Double) CUP$Parser$stack.elementAt(CUP$Parser$top - 3).value;
      Double e_false = (Double) CUP$Parser$stack.elementAt(CUP$Parser$top - 1).value;
      if (b) {
        RESULT = e_true;
      } else {
        RESULT = e_false;
      ...
      CUP$Parser$result = parser.getSymbolFactory().newSymbol("funcexpr", 5,
        (CUP$Parser$stack.elementAt(CUP$Parser$top - 7)),
        (CUP$Parser$stack.peek()), RESULT);
    }
      return CUP$Parser$result;
    ...
    {
      Double RESULT = null;
      String v = (String) CUP$Parser$stack.peek().value;
      ...
      CUP$Parser$result = parser.getSymbolFactory().newSymbol("varexpr", 4,
        (CUP$Parser$stack.peek()), (CUP$Parser$stack.peek()), RESULT);
    }
      return CUP$Parser$result;
    ...
    {
      Double RESULT = null;
      Double v = (Double) CUP$Parser$stack.peek().value;
      RESULT = v;
      CUP$Parser$result = parser.getSymbolFactory().newSymbol("expr", 2,
        (CUP$Parser$stack.peek()), (CUP$Parser$stack.peek()), RESULT);
    }
    ...
    {
      Object RESULT = null;
      Double e = (Double) CUP$Parser$stack.peek().value;
      parser.setResult(e);
