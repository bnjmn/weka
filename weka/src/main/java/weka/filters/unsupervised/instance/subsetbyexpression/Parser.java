 ...
 * 
 * @version Wed Jun 26 14:23:38 NZST 2013
 */
public class Parser extends java_cup.runtime.lr_parser {
  ...
  /** Production table. */
  protected static final short _production_table[][] = unpackFromStrings(new String[] { "\000\046\000\002\002\004\000\002\002\004\000\002\002"
  ...
  /** Parse-action table. */
  protected static final short[][] _action_table = unpackFromStrings(new String[] { "\000\142\000\050\005\016\007\033\014\026\015\012\016"
  ...
  protected static final short[][] _reduce_table = unpackFromStrings(new String[] { "\000\142\000\016\002\026\003\022\004\004\005\031\006"
  ...
  protected HashMap<String, Object> m_Symbols = new HashMap<String, Object>();
   ...
   */
  public void setSymbols(HashMap<String, Object> value) {
    m_Symbols = value;
  }
   ...
   */
  public void setAttributeTypes(Hashtable<String, Integer> value) {
   ...
   */
  public Hashtable<String, Integer> getAttributeTypes() {
  ...
  /**
   * Returns either a String object for nominal attributes or a Double for
   * numeric ones. For all other attribute types this method throws an
   * Exception. It also returns a Double object in case of a missing value (for
   * all attribute types!).
   * 
...
class CUP$Parser$actions {
  ...
  public final java_cup.runtime.Symbol CUP$Parser$do_action(
    ...
    {
      Double RESULT = null;
      Double e = (Double) CUP$Parser$stack.elementAt(CUP$Parser$top - 1).value;
      RESULT = new Double(Math.ceil(e));
      CUP$Parser$result = parser.getSymbolFactory().newSymbol("funcexpr", 4,
        (CUP$Parser$stack.elementAt(CUP$Parser$top - 3)),
        (CUP$Parser$stack.peek()), RESULT);
    }
    ...
    {
      Double RESULT = null;
      Double base = (Double) CUP$Parser$stack.elementAt(CUP$Parser$top - 3).value;
      Double exponent = (Double) CUP$Parser$stack.elementAt(CUP$Parser$top - 1).value;
      RESULT = new Double(Math.pow(base, exponent));
      CUP$Parser$result = parser.getSymbolFactory().newSymbol("funcexpr", 4,
        (CUP$Parser$stack.elementAt(CUP$Parser$top - 5)),
        (CUP$Parser$stack.peek()), RESULT);
    }
      return CUP$Parser$result;
    ...
    {
      Double RESULT = null;
      Double l = (Double) CUP$Parser$stack.elementAt(CUP$Parser$top - 2).value;
      Double r = (Double) CUP$Parser$stack.peek().value;
      RESULT = new Double(l.doubleValue() / r.doubleValue());
      CUP$Parser$result = parser.getSymbolFactory().newSymbol("opexpr", 3,
    ...
    {
      Double RESULT = null;
      Double f = (Double) CUP$Parser$stack.peek().value;
      RESULT = f;
      CUP$Parser$result = parser.getSymbolFactory().newSymbol("expr", 2,
        (CUP$Parser$stack.peek()), (CUP$Parser$stack.peek()), RESULT);
    }
      return CUP$Parser$result;
    ...
    {
      Double RESULT = null;
      Double o = (Double) CUP$Parser$stack.peek().value;
      RESULT = o;
      CUP$Parser$result = parser.getSymbolFactory().newSymbol("expr", 2,
        (CUP$Parser$stack.peek()), (CUP$Parser$stack.peek()), RESULT);
    }
    ...
    {
      Double RESULT = null;
      String a = (String) CUP$Parser$stack.peek().value;
    ...
    {
      Double RESULT = null;
      Double n = (Double) CUP$Parser$stack.peek().value;
      RESULT = n;
      CUP$Parser$result = parser.getSymbolFactory().newSymbol("expr", 2,
        (CUP$Parser$stack.peek()), (CUP$Parser$stack.peek()), RESULT);
    }
    ...
    {
      Boolean RESULT = null;
      String a = (String) CUP$Parser$stack.elementAt(CUP$Parser$top - 1).value;
      if (parser.getSymbols().containsKey(a)) {
        RESULT = (parser.getSymbols().get(a) instanceof Double)
          && Utils.isMissingValue((Double) parser.getSymbols().get(a));
      } else {
        throw new IllegalStateException("Unknown symbol '" + a + "'!");
      }

      CUP$Parser$result = parser.getSymbolFactory().newSymbol("boolexpr", 5,
        (CUP$Parser$stack.elementAt(CUP$Parser$top - 3)),
        (CUP$Parser$stack.peek()), RESULT);
    }
      return CUP$Parser$result;
    ...
    {
      Boolean RESULT = null;
      String a = (String) CUP$Parser$stack.elementAt(CUP$Parser$top - 2).value;
      String s = (String) CUP$Parser$stack.peek().value;
      if (parser.getSymbols().containsKey(a)) {
        RESULT = (parser.getSymbols().get(a) instanceof String)
          && ((String) parser.getSymbols().get(a)).equals(s);
      } else {
        throw new IllegalStateException("Unknown symbol '" + a + "'!");
      }
    ...
    {
      Boolean RESULT = null;
      Boolean l = (Boolean) CUP$Parser$stack.elementAt(CUP$Parser$top - 2).value;
      Boolean r = (Boolean) CUP$Parser$stack.peek().value;
      RESULT = l || r;
      CUP$Parser$result = parser.getSymbolFactory().newSymbol("boolexpr", 5,
        (CUP$Parser$stack.elementAt(CUP$Parser$top - 2)),
        (CUP$Parser$stack.peek()), RESULT);
    ...
    {
      Boolean RESULT = null;
      Boolean b = (Boolean) CUP$Parser$stack.peek().value;
      RESULT = !b;
      CUP$Parser$result = parser.getSymbolFactory().newSymbol("boolexpr", 5,
    ...
    {
      Boolean RESULT = null;
      Boolean b = (Boolean) CUP$Parser$stack.elementAt(CUP$Parser$top - 1).value;
      RESULT = b;
      CUP$Parser$result = parser.getSymbolFactory().newSymbol("boolexpr", 5,
        (CUP$Parser$stack.elementAt(CUP$Parser$top - 2)),
        (CUP$Parser$stack.peek()), RESULT);
    ...
    {
      Object RESULT = null;
      Boolean e = (Boolean) CUP$Parser$stack.peek().value;
      parser.setResult(e);
      CUP$Parser$result = parser.getSymbolFactory().newSymbol("boolexpr_part",
        1, (CUP$Parser$stack.peek()), (CUP$Parser$stack.peek()), RESULT);
    }
      return CUP$Parser$result;
    ...
    case 2: // boolexpr_list ::= boolexpr_part
    {
      ...
      CUP$Parser$result = parser.getSymbolFactory().newSymbol("boolexpr_list",
        0, (CUP$Parser$stack.peek()), (CUP$Parser$stack.peek()), RESULT);
    }
      return CUP$Parser$result;
    ...
    case 0: // boolexpr_list ::= boolexpr_list boolexpr_part
    {
      ...
      CUP$Parser$result = parser.getSymbolFactory().newSymbol("boolexpr_list",
        0, (CUP$Parser$stack.elementAt(CUP$Parser$top - 1)),
        (CUP$Parser$stack.peek()), RESULT);
    }
      return CUP$Parser$result;
