...
public class GenericArrayEditor extends JPanel implements PropertyEditor {
      ...
      if (e.getSource() == m_DeleteBut) {
        ...
        if (m_Editor.getValue() != null) {
          ...
          if (PropertyDialog.getParentDialog(GenericArrayEditor.this) != null) {
            ...
            m_PD = new PropertyDialog(
              PropertyDialog.getParentFrame(GenericArrayEditor.this), m_Editor,
              x, y);
          }
          m_PD.setVisible(true);
          m_ListModel
            .set(m_ElementList.getSelectedIndex(), m_Editor.getValue());
          m_Support.firePropertyChange("", null, null);
        }
        ...
        try {
          ...
          JOptionPane.showMessageDialog(GenericArrayEditor.this,
            "Could not create an object copy", null, JOptionPane.ERROR_MESSAGE);
        }
      }
    }
  };
  ...
  /**
   * Updates the type of object being edited, so attempts to find an appropriate
   * propertyeditor.
   * 
