...
public class GraphVisualizer extends JPanel implements GraphConstants, LayoutCompleteEventListener  {
    ...
    */
    ...
    private int nodeHeight = 2*fm.getHeight(), nodeWidth = 24, paddedNodeWidth = 24+8;
    ...
    /** Button for laying out the graph again, necessary after changing node's size or 
	some other property of the layout engine */
    ...
    private int [] zoomPercents = { 10, 25, 50, 75, 100, 125, 150, 175, 200, 225, 250, 275, 300, 
				    350, 400, 450, 500, 550, 600, 650, 700, 800, 900, 999 };
	...
	m_jBtSave.addActionListener( new ActionListener() {
				  ...
				  int rval = fc.showSaveDialog(GraphVisualizer.this);
				   ...
				   if (rval == JFileChooser.APPROVE_OPTION) {
				       //System.out.println("Saving to file \""+f.getAbsoluteFile().toString()+"\"");
	...
	jBtExtraControls.addActionListener( new ActionListener() {
				   ...
				   Thread th = new Thread() {
					   ...
					   public void run() {
						   ...
						   try {this.sleep(30);} catch(InterruptedException ie) {ie.printStackTrace(); break;}
					       }
