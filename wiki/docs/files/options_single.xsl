...
<!--  
  This little XSLT script parses an Experimenter XML options file (saved via the 
  "Save options..." button in the Experimenter) and outputs the classifiers and 
  their options in two formats:
